...
\begin{alertblock}{\Large Simulation}
  ...
  \vspace{-.2cm}
  \begin{figure}
    \includegraphics[width=.8\linewidth]{simulationimage.png}
    \vspace{-.5cm}
    \caption{Geant4 visualization of the RADiCAL module. Coincidence scintillators on the left in green, followed by the blue MCP, the RADiCAL module in the center, and the Pb-glass calorimeter on the right. The electron beam enters from the left and travels through the entire setup.}
  \end{figure}
\end{alertblock}
